          ...
          <ul className='side'>
            <li>
              ...
              <div className='text-container'>
                ...
                <p className='text'>
                  Stoicism was founded in Athens by Zeno of Citium after he was
                  inspired by the teachings of Socrates and the Cynics. He began
                  teaching his philosophy in the Stoa Poikile, a public porch in
                  Athens, from which the philosophy gets its name.
                </p>
              </div>
            </li>
            <li>
            ...
            <li>
              ...
              <div className='text-container'>
                ...
                <p className='text'>
                  Stoicism experienced a revival in modern times, especially in
                  self-help and therapy. Its practical approach to dealing with
                  adversity and focus on resilience and virtue have made it
                  relevant today, influencing practices like Cognitive
          ...
          <ul className='side right'>
            <li>
              <div className='text-container'>
                ...
                <p className='text'>
                  Stoicism was further developed by Zeno's successors, including
                  Cleanthes and Chrysippus. Chrysippus, in particular, played a
                  significant role in systematizing Stoic doctrines and making
                  Stoicism one of the most influential schools of Hellenistic
                  philosophy.
                </p>
              </div>
